(function()
{
    function patchFile(file)
    {
        ...
        file.read = function()
        {
            var fs = this.open(Tide.Filesystem.MODE_READ);
            var content = fs.read();
            fs.close();
            return content;
        }
        file.readLine = function()
        {
            ...
            {
                this._lineReader = this.open(Tide.Filesystem.MODE_READ);
            }
        ...
        {
            var fs = this.open(Tide.Filesystem.MODE_WRITE);
    ...
    var getFile = Tide.Filesystem.getFile; 
    Tide.Filesystem.getFile = function()
    {
        var file = getFile.apply(this, arguments);
        return patchFile(file);
    }

    var createTempFile = Tide.Filesystem.createTempFile;
    Tide.Filesystem.createTempFile = function()
    {
