  ...
  var Drillbit = function () {
    ...
    this.frontend_do = function () {
      try {
        ...
        if (this.frontend && fn_name in this.frontend && typeof this.frontend[fn_name] == 'function') {
      ...
      process.setOnReadLine(function (data) {
        ...
        if (i != -1) {
          ...
          if (test_passed) {
            ...
            var test_args = test_name.substring(0, dashes)
              .split(',');
    ...
    this.run_next_test = function () {
      if (executing_tests == null || executing_tests.length == 0) {
        this.test_duration = (new Date()
          .getTime() - this.tests_started) / 1000;
      ...
      this.run_tests_async ? this.window.setTimeout(function () {
        self.run_test(entry)
      }, 1) : this.run_test(entry);
    };
