describe("Ti.Filesystem tests",{
	...
	filesystem_basic_static_properties: function()
	{
		...
		for (var c=0;c<methods.length;c++)
		{
			...
			value_of(Ti.Filesystem[method]).should_be_function();
		}
	},
	
	other_props:function()
	{
		value_of(Ti.Filesystem.getLineEnding).should_be_function();
		value_of(Ti.Filesystem.getSeparator).should_be_function();
		value_of(Ti.Filesystem.MODE_READ).should_not_be_null();
		value_of(Ti.Filesystem.MODE_WRITE).should_not_be_null();
		value_of(Ti.Filesystem.MODE_APPEND).should_not_be_null();
				
		value_of(Ti.Filesystem.getLineEnding()).should_not_be_null();
		value_of(Ti.Filesystem.getSeparator()).should_not_be_null();
	},
	...
	temp_file:function()
	{
		value_of(Ti.Filesystem.createTempFile).should_be_function();
	...
	{
		value_of(Ti.Filesystem.createTempDirectory).should_be_function();
	...
	{
		value_of(Ti.Filesystem.getProgramsDirectory).should_be_function();
		value_of(Ti.Filesystem.getApplicationDirectory).should_be_function();
		value_of(Ti.Filesystem.getRuntimeHomeDirectory).should_be_function();
		value_of(Ti.Filesystem.getResourcesDirectory).should_be_function();
		value_of(Ti.Filesystem.getDesktopDirectory).should_be_function();
		value_of(Ti.Filesystem.getDocumentsDirectory).should_be_function();
		value_of(Ti.Filesystem.getUserDirectory).should_be_function();
		
		value_of(Ti.Filesystem.getProgramsDirectory()).should_not_be_null();
		value_of(Ti.Filesystem.getApplicationDirectory()).should_not_be_null();
		value_of(Ti.Filesystem.getRuntimeHomeDirectory()).should_not_be_null();
		value_of(Ti.Filesystem.getResourcesDirectory()).should_not_be_null();
		value_of(Ti.Filesystem.getDesktopDirectory()).should_not_be_null();
		value_of(Ti.Filesystem.getDocumentsDirectory()).should_not_be_null();
		value_of(Ti.Filesystem.getUserDirectory()).should_not_be_null();
	},
	...
	test_ApplicationDirectory: function()
	{
		...
		value_of( f == Ti.App.home ).should_be_true();		
	},
	...
	test_ResourcesDirectory: function()
	{
		...
		value_of( f.nativePath().indexOf(Ti.Filesystem.getApplicationDirectory())).should_not_be(-1);
	},
	...
	{
		value_of(Ti.Filesystem.getRootDirectories).should_be_function();
	...
	test_line_endings: function()
	{
        ...
        if ( Ti.platform == 'win32' )
        {
            ...
            value_of(Ti.Filesystem.getLineEnding()).should_be("\n");
        }
        else 
        {
            value_of(Ti.Filesystem.getLineEnding()).should_be("\n");
	...
	test_separator: function ()
	{
        ...
        if ( Ti.platform == 'win32' )
        {
            value_of(Ti.Filesystem.getSeparator()).should_be("\\");
        }
        else 
        {
            value_of(Ti.Filesystem.getSeparator()).should_be("/");
