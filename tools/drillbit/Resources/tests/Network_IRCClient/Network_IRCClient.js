describe("Network.IRCClient",{
	...
	before_all: function()
	{
		...
		value_of(Ti.Network.IRCClient).should_not_be_null();
	...
	test_network_connect_as_async: function(test)
	{
		...
		//try
		//{
		//	client.connect("irc.freenode.net", 6667, "drillbit_tester_app", "TiDrillbit", "tester", String(new Date().getTime()), function(cmd, channel, data, nick)
		//	{
