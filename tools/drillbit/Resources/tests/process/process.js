describe("process tests",
{
	...
	{
		value_of(Ti.Process).should_not_be_null();
		value_of(Ti.Process.createProcess).should_be_function();
		value_of(Ti.Process.createPipe).should_be_function();
	},
	...
	{
		value_of(function(){ Ti.Process.createProcess(); }).should_throw_exception();
		value_of(function(){ Ti.Process.createProcess(null); }).should_throw_exception();
		value_of(function(){ Ti.Process.createProcess([null]); }).should_throw_exception();
		value_of(function(){ Ti.Process.createProcess([]); }).should_throw_exception();
	...
	{
		value_of(Ti.Process).should_not_be_null();
		var p = Ti.Process.createProcess(Ti.platform == "win32" ?
